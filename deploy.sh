...
echo "   2. Test forgot password: curl -X POST http://https://api.cryptomonitor.app/auth/forgot-password -H 'Content-Type: application/json' -d '{\"email\":\"gurgen@2vmdls.com\"}'"
